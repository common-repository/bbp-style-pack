...
/** THIS IS AN AMENDED bbpress\includes\admin\classes\class-bbp-admin.php file loaded in bbp-stye-pack.php around line 92


PHP 8.2 issues a 'Deprecated: Creation of dynamic property BBP_Admin::$forums is deprecated' notice
This link  https://php.watch/versions/8.2/dynamic-properties-deprecated  provides an explanation, 
so as bbp-style-pack usually loads before bbpress, and the class has a !class exists 
we can add the #[AllowDynamicProperties] item to it to make it load ok
